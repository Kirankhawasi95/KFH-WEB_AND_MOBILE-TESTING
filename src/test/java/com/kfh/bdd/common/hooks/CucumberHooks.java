package com.kfh.bdd.common.hooks;
...
//		}
	...
	public void after(Scenario scenario) throws Exception {
		...
		if (str_Execution_TYPE.equalsIgnoreCase("Web_UI")) {
			...
			DriverFactory.getInstance().getMobileDriver().terminateApp("com.curebay.medicare");
...
//			DriverFactory.getInstance().getWindowDriver().closeApp();
//			DriverFactory.getInstance().getWindowDriver().activateApp(ConfigReader.getValue("ExePath"));
		}
		else if (str_Execution_TYPE.equalsIgnoreCase("API")) {
